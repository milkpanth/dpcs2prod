...
let TagsRepository = class TagsRepository {
    constructor(useTagRepo, liveTagRepo, logger) {
        this.useTagRepo = useTagRepo;
        this.liveTagRepo = liveTagRepo;
        this.logger = logger;
        this.logger.setContext("TagsRepository");
    }
    async findAll(queryPayload, databaseType) {
        ...
        if (databaseType === database_type_enum_1.DataBaseTypeEnum.USE) {
            repo = this.useTagRepo;
        }
        else {
            repo = this.liveTagRepo;
        }
        const result = await (0, nestjs_typeorm_paginate_1.paginate)(repo, (0, pagination_1.getBasePaginationOption)(queryPayload), {
            ...
            where: Object.assign({}, (0, pagination_1.getBaseWhereOption)(queryPayload, Object.assign({ Name: (0, typeorm_2.Like)(`%${(0, entity_helper_1.escapeLikeString)(queryPayload.keyword)}%`) }, (0, pagination_1.getBaseStatusOption)(queryPayload)), (0, pagination_1.getBaseStatusOption)(queryPayload))),
...
TagsRepository = __decorate([
    ...
    __param(1, (0, typeorm_1.InjectRepository)(tag_entity_1.Tag, db_1.LIVE_DB_NAME)),
