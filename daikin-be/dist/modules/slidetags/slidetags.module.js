...
const slidetags_repository_1 = require("./slidetags.repository");
...
SlideTagsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [],
        providers: [slidetags_repository_1.SlideTagsRepository],
        exports: [slidetags_repository_1.SlideTagsRepository],
    })
], SlideTagsModule);
exports.SlideTagsModule = SlideTagsModule;
//# sourceMappingURL=slidetags.module.js.map