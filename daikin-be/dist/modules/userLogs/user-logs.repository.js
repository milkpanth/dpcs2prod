...
exports.UserLogsRepository = void 0;
...
let UserLogsRepository = class UserLogsRepository {
    constructor(useUserLogsRepo, liveUserLogsRepo, logger) {
        this.useUserLogsRepo = useUserLogsRepo;
        this.liveUserLogsRepo = liveUserLogsRepo;
        this.logger = logger;
        this.logger.setContext("UserLogsRepository");
    }
    async insertOrUpsert(userLogsPayLoad, databaseType) {
        this.logger.log(`insertOrUpsert --> DB`, {
            userLogsPayLoad: userLogsPayLoad,
            databaseType: databaseType,
        });
        let repo;
        if (databaseType === database_type_enum_1.DataBaseTypeEnum.USE) {
            repo = this.useUserLogsRepo;
        }
        else {
            repo = this.liveUserLogsRepo;
        }
        const result = await repo.save(userLogsPayLoad);
...
UserLogsRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(user_logs_entity_1.UserLogs, db_1.USE_DB_NAME)),
    __param(1, (0, typeorm_1.InjectRepository)(user_logs_entity_1.UserLogs, db_1.LIVE_DB_NAME)),
    __metadata("design:paramtypes", [typeorm_2.Repository,
        typeorm_2.Repository,
        app_logger_1.AppLoggerService])
], UserLogsRepository);
exports.UserLogsRepository = UserLogsRepository;
//# sourceMappingURL=user-logs.repository.js.map